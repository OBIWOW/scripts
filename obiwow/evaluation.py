...
if  __name__ == '__main__':
    ...
    evaluation_all_folder = "/Users/alexajo/alexajo@uio.no - Google Drive/Min disk/Student_Committee_SBI/OBiWoW2023/evaluation/" 
...
"""
    ...
    for key in dict_schedule:
        ...
        workshop_short_title = workshop_title.replace(" ", "_").replace(":", "").replace("/", "").replace("&", "").replace("__", "_")
